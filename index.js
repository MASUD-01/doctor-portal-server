...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.byzzp.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;
...
async function run() {
    try {
         ...
         * app.put('/booking/:id')//upsert ==> update(if exists) or insert (if doesnot exists)
         * app.delelte('booking/:id')
         * 
        */
        ...
        app.get('/available', async (req, res) => {
            ...
            services.forEach(service => {
                ...
                //steps 7 set available to slots to make it easier
